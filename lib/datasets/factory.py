...
for split in ['train', 'train_13', 'train_coco', 'train_17', 'test_17',
              ...
              'valid', 'train_synth', 'test_synth', 'test_mlt', 'train_mlt', 'valid_mlt', 'train_rotate', 'train_mlt_rotate']:
...
def adjust_args(args):
    if args.dataset == "pascal_voc":
        ...
        args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.125,0.25,0.5,1,2,4,8]', 'MAX_NUM_GT_BOXES',
                         '100',  'TEST.SCALES', '[1600]', 'TEST.MAX_SIZE', '2000']
    elif args.dataset == "icdar_mlt" or args.dataset == 'icdar_17':
        args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.25,0.5,1,2,4]',
                         'MAX_NUM_GT_BOXES', '100', 'TRAIN.SCALES', '[1200]', 'TRAIN.MAX_SIZE', '2000',
