...
__C.TRAIN.SCALES = (480, 576, 688, 864,1500,)
...
# Enable on line hard negtive mining
__C.TRAIN.ENABLE_OHEM = False

# Batch size of hard example
__C.TRAIN.BATCH_ROIS_OHEM = 256

# Use edge loss
__C.TRAIN.EDGE_LOSS = False
#
# Testing options
#
__C.TEST = edict()
