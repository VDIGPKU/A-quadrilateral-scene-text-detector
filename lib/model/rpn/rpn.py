...
from lib.model.rpn.proposal_layer import ProposalLayer
from lib.model.rpn.anchor_target_layer import AnchorTargetLayer
...
class RPN(nn.Module):
    ...
    def __init__(self, din):
        ...
        self.nc_bbox_out = len(self.anchor_scales) * len(self.anchor_ratios) * 5 # 4(coords) * 9 (anchors)
