...
class ProposalTargetLayer(nn.Module):
    ...
    def forward(self, all_rois, gt_boxes, num_boxes):
        ...
        return rois, labels, poly_targets, poly_inside_weights, poly_outside_weights, gt_sample
    ...
    def _get_bbox_regression_labels_pytorch(self, bbox_target_data, poly_target_data, labels_batch, num_classes):
        ...
        poly_targets = poly_target_data.new(batch_size, rois_per_image, 5).zero_()
    ...
    def _compute_targets_pytorch(self, ex_rois, gt_rois):
        ...
        targets, poly_targets = bbox_transform_batch_reg(ex_rois, gt_rois)
    ...
    def _sample_rois_pytorch(self, all_rois, gt_boxes, fg_rois_per_image, rois_per_image, num_classes):
        ...
        bbox_target_data, poly_target_data = self._compute_targets_pytorch(
                rois_batch[:,:,1:5], gt_rois_batch[:,:,:p])

        bbox_targets, bbox_inside_weights, poly_targets, poly_inside_weights = \
                self._get_bbox_regression_labels_pytorch(bbox_target_data, poly_target_data, labels_batch, num_classes)
