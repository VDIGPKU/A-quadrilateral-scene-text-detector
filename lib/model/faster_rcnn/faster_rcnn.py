...
class FasterRCNN(nn.Module):
    ...
    def forward(self, im_data, im_info, gt_boxes, num_boxes):
        ...
        if self.training:
            ...
            rois, rois_label, rois_target, rois_inside_ws, rois_outside_ws, gt_sample = roi_data
        ...
        return rois, cls_prob, bbox_pred, rpn_loss_cls, rpn_loss_bbox, RCNN_loss_cls, RCNN_loss_bbox, RCNN_loss_edge, rois_label
